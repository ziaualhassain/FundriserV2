...
test('storage upgrade with gap', t => {
    ...
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(v1, v2_Ok), []);
    t.like((0, storage_1.getStorageUpgradeErrors)(v1, v2_Bad1), {
        length: 2,
        0: {
            kind: 'layoutchange',
            change: {
    ...
    t.like((0, storage_1.getStorageUpgradeErrors)(v1, v2_Bad2), {
        length: 2,
        0: {
            kind: 'delete',
            original: { label: 'b' },
    ...
    t.like((0, storage_1.getStorageUpgradeErrors)(v1, v2_Bad3), {
        length: 2,
        0: {
            kind: 'typechange',
            change: { kind: 'array shrink' },
    ...
    t.like((0, storage_1.getStorageUpgradeErrors)(v1, v2_Bad4), {
        length: 2,
        0: {
            kind: 'typechange',
            change: { kind: 'array shrink' },
    ...
    t.like((0, storage_1.getStorageUpgradeErrors)(v1, v2_Bad5), {
        length: 2,
        0: {
            kind: 'typechange',
            change: { kind: 'array shrink' },
...
test('storage upgrade that consumes gap and inherited gap', t => {
    ...
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(v1a, v2a), []);
    t.like((0, storage_1.getStorageUpgradeErrors)(v1b, v2a), {
        length: 1,
        0: {
            kind: 'delete',
            original: { label: '__gap' },
    ...
    t.like((0, storage_1.getStorageUpgradeErrors)(v1c, v2a), {
        length: 2,
        0: {
            kind: 'delete',
            original: { label: '__gap' },
    ...
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(v1b, v2b), []);
});
...
test('storage upgrade with different typed gaps', t => {
    ...
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(uint256gap_address_v1, uint256gap_address_v2), []);
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(address_v1, address_v2), []);
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(uint128_v1, uint128_v2_ok), []);
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(uint128_v1, uint128_v2b_ok), []);
    t.like((0, storage_1.getStorageUpgradeErrors)(uint128_v1, uint128_v2_bad), {
        length: 2,
        0: {
            kind: 'layoutchange',
            change: {
    ...
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(bool_v1, bool_v2_ok), []);
    t.like((0, storage_1.getStorageUpgradeErrors)(bool_v1, bool_v2_bad), {
        length: 2,
        0: {
            kind: 'typechange',
            change: { kind: 'array shrink' },
...
test('storage upgrade with one element gap', t => {
    ...
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(v1, v2_Ok), []);
    t.deepEqual((0, storage_1.getStorageUpgradeErrors)(v1, v2b_Ok), []);
    t.like((0, storage_1.getStorageUpgradeErrors)(v1, v2_Bad), {
        length: 2,
        0: {
            kind: 'layoutchange',
